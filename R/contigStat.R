...
nohitContigsByCoverage<-function(list_map)
{
    ...
    write.csv(noHitContigs,file="/Volumes/ma-home/shyama/code/SYBARIS/R/log/noHitContigsByCoverage.csv")
}
...
{
    hit_def_all=sub('(.*)?Neosartorya fumigata(.*)?','Aspergillus fumigatus A1163',tab2[,"hit_def"])
    ...
    write.csv(count_sample_wise,file="/Volumes/ma-home/shyama/code/SYBARIS/R/log/match_count_all_sample_wise.csv",quote=FALSE)
}
...
main<-function()
{
    ...
    #tab1=read.csv(file="/Volumes/ma-home/shyama/outputs/SYBARIS/Python/output/contig_blast_OG_gap_penalty_coverage_stat.csv",header=TRUE)
    tab2=read.csv(file="/Volumes/ma-home/shyama/code/SYBARIS/Python/log/contigStat_fungi_complete.csv",header=TRUE)
    ...
    geneInfo(list_map,tab2,file_names)
    ##matchReference(list_map,tab2,file_names)
    ...
    ##write.csv(matchPercent,file="/Volumes/ma-home/shyama/code/SYBARIS/R/log/unaligned.csv")
    ##write.csv(matchPercentCoverage,file="/Volumes/ma-home/shyama/code/SYBARIS/R/log/unalignedCoverage.csv")
...
density_plot<-function(list_map)
{
    ...
    pdf(file="/Volumes/ma-home/shyama/code/SYBARIS/R/log/identityVSlength_Coverage1.pdf",width=10,height=11,paper="a4")
    par(mfcol=c(5,2))
    for(i in 1:10)
    {
    ...
    pdf(file="/Volumes/ma-home/shyama/code/SYBARIS/R/log/identityVSlength_Coverage2.pdf",width=10,height=11,paper="a4")
    par(mfcol=c(5,2))
...
hist_plot<-function(list_map)
{
    ...
    pdf(file="/Volumes/ma-home/shyama/code/SYBARIS/R/log/identityVSlength_hist1.pdf",width=10,height=11,paper="a4")
    par(mfcol=c(5,2))
    for(i in 1:10)
    {
    ...
    pdf(file="/Volumes/ma-home/shyama/code/SYBARIS/R/log/identityVSlength_hist2.pdf",width=10,height=11,paper="a4")
    par(mfcol=c(5,2))
    for(i in 11:length(list_map))
    {
        coverage=list_map[[i]][,"coverage."]
