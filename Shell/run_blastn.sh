...
#bsub -o /nfs/ma/home/shyama/outputs/blastn_job.out -M 10000 -R 'rusage[mem=10000]' "./blastn -db $db -query $f/contigs.fa -gapopen 4 -gapextend 2 -out $out$contig_file_name\".out\" -outfmt 5"
    bsub -o /nfs/ma/home/shyama/outputs/blastx_job.out -M 10000 -R 'rusage[mem=10000]' -q research-rh6 "./blastx -db $db -query $f/contigs.fa -gapopen 6 -gapextend 2 -out $out$contig_file_name\".out\" -outfmt 5"
    fi
done
